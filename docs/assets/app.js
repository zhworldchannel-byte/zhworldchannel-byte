...
const SOCIALS = [
  ...
  {href:'https://devpost.com/zainhamidzia',label:'Devpost',icon:'<path d="M6.002 1.61 0 12.004 6.002 22.39h11.996L24 12.004 17.998 1.61zm1.593 4.084h3.947c3.605 0 6.276 1.137 6.276 4.32 0 2.054-1.07 3.487-2.774 4.014l3.254 4.912h-3.215l-2.99-4.6H9.95v4.6H7.595zm3.355 2.07v2.89h1.653c1.63 0 2.432-.571 2.432-1.481 0-.858-.746-1.409-2.016-1.409z"/>'}
];
...
<span class="g">── links · navigation ──</span>
  resume  contact  email  github  linkedin  instagram  devpost  social  open &lt;page&gt;
...
<span class="g">── fun ──</span>
  ...
  ping  weather  reboot  42  secret  credits  sudo  exit`,
    ...
    websites:()=>'• Zain\'s World → <a href="https://zainhamidzia.wixsite.com/website" target="_blank" style="color:var(--cyan)">zainhamidzia.wixsite.com/website</a> · first site ever published · 2021 · blog\n• Digital Delights — game/social/proxy hub · profitable\n• Arena Shooter — browser game',
    ...
    devpost:()=>open('https://devpost.com/zainhamidzia'),
    social:()=>'linkedin.com/in/zain-hamid-390523393 · instagram.com/zainy_2012 · github.com/zhworldchannel-byte · devpost.com/zainhamidzia',
